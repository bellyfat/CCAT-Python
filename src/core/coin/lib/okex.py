...
class Okex(Coin):
    ...
    def __init__(self, exchange="Okex", api_key, api_secret, passphrase, proxies=None):
        ...
        self._restTradeAPI = OkexTradeClient(self._api_key, self._api_secret, self.proxies)
