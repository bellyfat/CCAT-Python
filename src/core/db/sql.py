...
INSERT_WITHDRAW_HISTORY_SQL_TITLE = '''
    INSERT INTO ACCOUNT_WITHDRAW_HISTORY (server, timeStamp, asset, deposite, withdraw)
    VALUES'''
INSERT_WITHDRAW_HISTORY_SQL_VALUE = Template('''
    ('$server', $timeStamp, '$asset', '$deposite', '$withdraw')''')
...
INSERT_INFO_SERVER_SQL_TITLE = '''
    ...
    VALUES'''
INSERT_INFO_SERVER_SQL_VALUE = Template('''
    ('$server', $requests_second, $orders_second, $orders_day, $webSockets_second)''')
...
INSERT_INFO_SYMBOL_SQL_TITLE = '''
    ...
    VALUES'''
INSERT_INFO_SYMBOL_SQL_VALUE = Template('''
    ('$server', '$fSymbol', '$tSymbol', $limit_price_precision, $limit_price_max, $limit_price_min, $limit_price_step, $limit_size_precision, $limit_size_max, $limit_size_min, $limit_size_step, $limit_min_notional, $fee_maker, $fee_taker)''')
...
INSERT_INFO_WITHDRAW_SQL_TITLE = '''
    ...
    VALUES'''
INSERT_INFO_WITHDRAW_SQL_VALUE = Template('''
    ('$server', '$asset', '$can_deposite', '$can_withdraw', $min_withdraw)''')
...
INSERT_MARKET_DEPTH_SQL_TITLE = '''
    ...
    VALUES'''
INSERT_MARKET_DEPTH_SQL_VALUE = Template('''
    ('$server', $timeStamp, '$fSymbol', '$tSymbol', '$bid_price_size', '$ask_price_size')''')
...
INSERT_MARKET_KLINE_SQL_TITLE = '''
    ...
    VALUES'''
INSERT_MARKET_KLINE_SQL_VALUE = Template('''
    ('$server', $timeStamp, '$fSymbol', '$tSymbol', $open, $high, $low, $close, $volume)''')
...
INSERT_MARKET_TIKER_SQL_TITLE = '''
    ...
    VALUES'''
INSERT_MARKET_TIKER_SQL_VALUE = Template('''
    ('$server', $timeStamp, '$fSymbol', '$tSymbol', $bid_one_price, $bid_one_size, $ask_one_price, $ask_one_size)''')
...
INSERT_TRADE_BACKTEST_HISTORY_SQL_TITLE = '''
    ...
    VALUES'''
INSERT_TRADE_BACKTEST_HISTORY_SQL_VALUE = Template('''
    ('$server', $timeStamp, '$order_id', '$status', '$type', '$fSymbol', '$tSymbol', '$ask_or_bid', $ask_bid_price, $ask_bid_size, $filled_price, $filled_size, $fee)''')
...
INSERT_TRADE_ORDER_HISTORY_SQL_TITLE = '''
    ...
    VALUES'''
INSERT_TRADE_ORDER_HISTORY_SQL_VALUE = Template('''
    ('$server', $timeStamp, '$order_id', '$status', '$type', '$fSymbol', '$tSymbol', '$ask_or_bid', $ask_bid_price, $ask_bid_size, $filled_price, $filled_size, $fee)''')
